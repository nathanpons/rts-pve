...
class ScriptEditor(py4godot_panelcontainer.PanelContainer):
  ...
  @functools.native_method
  def get_current_script(self) -> typing.Union['py4godot_script.Script','py4godot_scriptextension.ScriptExtension','py4godot_gdscript.GDScript']:
    r'''
