...
class OpenXRIPBinding(py4godot_resource.Resource):
  ...
  @property
  def binding_modifiers(self) -> typing.Union['py4godot_openxranalogthresholdmodifier.OpenXRAnalogThresholdModifier','py4godot_openxractionbindingmodifier.OpenXRActionBindingModifier']:
    r''''''
  ...
  @functools.native_method
  def get_binding_modifier(self, index:'int'   ) -> typing.Union['py4godot_openxranalogthresholdmodifier.OpenXRAnalogThresholdModifier','py4godot_openxractionbindingmodifier.OpenXRActionBindingModifier']:
    r''''''
