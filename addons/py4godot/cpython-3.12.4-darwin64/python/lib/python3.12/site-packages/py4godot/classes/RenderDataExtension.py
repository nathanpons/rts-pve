...
class RenderDataExtension(py4godot_renderdata.RenderData):
  ...
  @functools.native_method
  def _get_render_scene_data(self) -> typing.Union['py4godot_renderscenedatard.RenderSceneDataRD','py4godot_renderscenedata.RenderSceneData','py4godot_renderscenedataextension.RenderSceneDataExtension']:
    r'''
