...
class WorldEnvironment(py4godot_node.Node):
  ...
  @functools.native_method
  def get_camera_attributes(self) -> typing.Union['py4godot_cameraattributespractical.CameraAttributesPractical','py4godot_cameraattributes.CameraAttributes','py4godot_cameraattributesphysical.CameraAttributesPhysical']:
    r''''''
