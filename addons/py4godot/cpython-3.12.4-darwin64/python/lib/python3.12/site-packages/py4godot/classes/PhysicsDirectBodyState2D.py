...
class PhysicsDirectBodyState2D(py4godot_object.Object):
  ...
  @functools.native_method
  def get_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate2dextension.PhysicsDirectSpaceState2DExtension','py4godot_physicsdirectspacestate2d.PhysicsDirectSpaceState2D']:
    r'''
