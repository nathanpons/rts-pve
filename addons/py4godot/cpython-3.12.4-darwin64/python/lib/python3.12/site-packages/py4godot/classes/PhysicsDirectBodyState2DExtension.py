...
'''
  ...
  @functools.native_method
  def _get_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate2dextension.PhysicsDirectSpaceState2DExtension','py4godot_physicsdirectspacestate2d.PhysicsDirectSpaceState2D']:
    r'''
