...
class ConvertTransformModifier3D(py4godot_boneconstraint3d.BoneConstraint3D):
  r'''
		...
		**Note:** Relative option is available only in the case `BoneConstraint3D.get_reference_type` is `constant BoneConstraint3D.REFERENCE_TYPE_BONE`. See also `enum BoneConstraint3D.ReferenceType`.
	'''
