...
class RenderData(py4godot_object.Object):
  ...
  @functools.native_method
  def get_render_scene_data(self) -> typing.Union['py4godot_renderscenedatard.RenderSceneDataRD','py4godot_renderscenedata.RenderSceneData','py4godot_renderscenedataextension.RenderSceneDataExtension']:
    r'''
